...
def upapk():
    deploy_to = '/home/public/staff2'    
    # local('cd platforms/android/build/outputs/apk&&mv android-debug.apk staff2.apk')       
    # local('scp www.tar.gz gsp@changiif.com:%s'%(deploy_to))
    # get('/remote/path/','/local/path/')
    put('platforms/android/build/outputs/apk/staff2.apk', deploy_to)
